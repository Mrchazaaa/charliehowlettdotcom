<template>
  <div id="content-container">
    ...
    <div id="content-collection-container">
      <div class="column">
        <!--Previous work-->
        <div class="content-collection" id="prev-work">
          <h2>Previous Work</h2>
          <!-- <WorkTableComponent /> -->
        ...
        <!--Hobbies-->
        <div class="content-collection" id="hobbies">
          <h2>Hobbies</h2>
          <p>
      ...
      <div class="column">
        <!--University info-->
        <div class="content-collection" id="uni-info">
          <h2>University</h2>
          <p>
        ...
        <!--Volunteering-->
        <div class="content-collection" id="volunteering">
          <h2>Volunteering</h2>
          <p>
