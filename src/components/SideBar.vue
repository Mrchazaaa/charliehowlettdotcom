...
<div id="sidebar-wrapper">
    ...
    <div id="button-wrapper">
        <button type="button" id="menu-close" class="btn btn-danger"><img src="../assets/x.svg"></button>
    </div>
    <a href="#sketch" role="button" class="btn btn-light btn-block"><h3>Top</h3></a>
